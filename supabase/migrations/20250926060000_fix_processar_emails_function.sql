-- Corrigir definitivamente a função processar_emails_pendentes que ainda tem cp.cliente_id
-- Esta função está causando o erro "column cp.cliente_id does not exist"
