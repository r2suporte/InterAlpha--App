...
// Comando para login
Cypress.Commands.add('login', (email = 'admin@interalpha.com', password = 'admin123') => {
  cy.visit('/auth/login')
...
const loginCredentials = {
  ...
  gerente_financeiro: { email: 'gerente.financeiro@interalpha.com', password: 'financeiro123' },
  supervisor_tecnico: { email: 'supervisor.tecnico@interalpha.com', password: 'SupervisorTec123!' },
