...
export function SectionCards() {
  return (
    <div className="@xl/main:grid-cols-2 @5xl/main:grid-cols-4 grid grid-cols-1 gap-6 px-4 lg:px-6">
      <Card className="@container/card relative overflow-hidden border-0 bg-gradient-to-br from-blue-50 to-blue-100/50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-blue-950/50 dark:to-blue-900/30">
      ...
      <Card className="@container/card relative overflow-hidden border-0 bg-gradient-to-br from-emerald-50 to-emerald-100/50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-emerald-950/50 dark:to-emerald-900/30">
      ...
      <Card className="@container/card relative overflow-hidden border-0 bg-gradient-to-br from-amber-50 to-amber-100/50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-amber-950/50 dark:to-amber-900/30">
      ...
      <Card className="@container/card relative overflow-hidden border-0 bg-gradient-to-br from-violet-50 to-violet-100/50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-violet-950/50 dark:to-violet-900/30">
