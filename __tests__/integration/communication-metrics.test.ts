...
describe('Communication Metrics Integration Tests - Simplified', () => {
  beforeEach(() => {
    ...
    mockMetricsService.measureOperation.mockImplementation(
      async (operation, fn) => {
  ...
  describe('Email Metrics', () => {
    it('deve registrar métricas de envio de email', async () => {
      ...
      expect(mockEmailService.sendOrdemServicoEmail).toHaveBeenCalledWith(
        ordemServico
      );
  ...
  describe('Performance Metrics', () => {
    it('deve medir tempo de resposta das operações', async () => {
      ...
      const result = await mockMetricsService.measureOperation(
        'test',
        testOperation
      );

      expect(mockMetricsService.measureOperation).toHaveBeenCalledWith(
        'test',
        testOperation
      );
