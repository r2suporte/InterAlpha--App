      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col">
          <div className="@container/main flex flex-1 flex-col gap-6 p-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  variant="outline"
                  onClick={() =>
                    router.push(`/dashboard/ordem-servico/${ordem.id}/edit`)
                  }
                >
            ...
            {/* Status e Prioridade */}
            <div className="flex items-center gap-4">
              <Badge variant="outline" className={STATUS_COLORS[ordem.status]}>
              ...
              <div className="space-y-6 lg:col-span-2">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <h4 className="mb-2 font-medium">Problema Reportado</h4>
                      <p className="text-gray-700">
                        {ordem.problema_reportado}
                      </p>
                    </div>
                    ...
                    {ordem.analise_tecnica && (
                      <div>
                        <h4 className="mb-2 font-medium">Análise Técnica</h4>
                    ...
                    {ordem.solucao_aplicada && (
                      <div>
                        <h4 className="mb-2 font-medium">Solução Aplicada</h4>
                        <p className="text-gray-700">
                          {ordem.solucao_aplicada}
                        </p>
                      </div>
                    ...
                    {ordem.valor_aprovado_cliente && (
                      <>
                        ...
                        <div className="flex justify-between text-green-600">
                          <span>Aprovado:</span>
                          <span className="font-medium">
                            {formatarMoeda(ordem.valor_aprovado_cliente)}
                          </span>
                        </div>
                      </>
                    )}
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {ordem.data_conclusao && (
                      <div>
                        ...
                        <p className="font-medium">
                          {new Date(ordem.data_conclusao).toLocaleDateString(
                            'pt-BR'
                          )}
                        </p>
                      </div>
                    ...
                    {ordem.data_entrega && (
                      <div>
                        ...
                        <p className="font-medium">
                          {new Date(ordem.data_entrega).toLocaleDateString(
                            'pt-BR'
                          )}
                        </p>
                      </div>
