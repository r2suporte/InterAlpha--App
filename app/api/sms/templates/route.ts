  ...
  try {
    const templates = {
      bemVindo: {
        ...
        preview: '🎉 Bem-vindo à InterAlpha, João! Estamos prontos para cuidar dos seus equipamentos Apple com excelência.'
      },
      lembreteManutencao: {
        ...
        preview: '🔧 Maria, que tal agendar uma manutenção preventiva para seu MacBook Pro? Entre em contato conosco!'
      },
      promocao: {
        name: 'Promoção',
        ...
        preview: '🎁 Carlos, oferta especial! 20% de desconto em serviços. Válido até o final do mês!'
      },
      agendamento: {
        ...
        preview: '📅 Ana, seu agendamento está confirmado para 15/01/2024 às 14:30. Aguardamos você!'
      }
    };
