      ...
      try {
        switch (template) {
          ...
          case 'lembreteManutencao':
            messageToSend = SMSService.templates.lembreteManutencao(
              templateData.nome,
              templateData.equipamento
            );
            break;
          case 'promocao':
            messageToSend = SMSService.templates.promocao(
              templateData.nome,
              templateData.desconto
            );
            break;
          case 'agendamento':
            messageToSend = SMSService.templates.agendamento(
              templateData.nome,
              templateData.data,
              templateData.hora
            );
